...
#Buraya eklediðim kýsýmý tamamen totomdan atýyom hata çýkrasa yüksek ihtimalle sorun burdadýr!
set_property -dict { PACKAGE_PIN T18  IOSTANDARD LVCMOS33 } [get_ports { clk_changer }];
#A oyuncusunun direction buttonlarýndan bi saðdaki butonu seçmiþ olmam lazým hesaplarým doðruysa aksjhdaksjdhaksjdhaksd, onu dene olmadý kendin boardýn üstünden bakýp doldur T18 kýsmýný

#NeededGoal
set_property -dict { PACKAGE_PIN V10  IOSTANDARD LVCMOS33 } [get_ports { NeededGoal[2] }];
set_property -dict { PACKAGE_PIN U11  IOSTANDARD LVCMOS33 } [get_ports { NeededGoal[1] }];
set_property -dict { PACKAGE_PIN U12  IOSTANDARD LVCMOS33 } [get_ports { NeededGoal[0] }];

#Side
set_property -dict { PACKAGE_PIN V10  IOSTANDARD LVCMOS33 } [get_ports { Side[2] }];
set_property -dict { PACKAGE_PIN U11  IOSTANDARD LVCMOS33 } [get_ports { Side[1] }];
set_property -dict { PACKAGE_PIN U12  IOSTANDARD LVCMOS33 } [get_ports { Side[0] }];
...
set_property -dict { PACKAGE_PIN T15  IOSTANDARD LVCMOS33 } [get_ports { LEDX[6] }];
set_property -dict { PACKAGE_PIN V16  IOSTANDARD LVCMOS33 } [get_ports { LEDX[5] }];
